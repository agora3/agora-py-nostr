...
from agama_nostr.client import RELAY_URL
...
if __name__ == "__main__":
    ...
    dm.encrypt( sender_pk.hex(), cleartext_content=msg, recipient_pubkey=recipient.hex(), )

    filters = FiltersList(
        [
        Filters(authors=[recipient.hex()], kinds=[EventKind.ENCRYPTED_DIRECT_MESSAGE],since=get_timestamp(),limit=10, )
        ]
    )
